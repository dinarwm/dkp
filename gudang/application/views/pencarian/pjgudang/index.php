    ...
    return confirm('Apakah Anda yakin akan menghapus data ini?');
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Pencarian Penanggung Jawab Gudang
            <small>Daftar PJ Gudang</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-users"></i> Pencarian</a></li>
            <li class="active"> Penanggung Jawab Gudang</li>
          </ol>
        </section>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th style="background-color:#FACC2E!important">ALAMAT</th>
                        <th style="background-color:#FACC2E!important">NAMA PENANGGUNG JAWAB</th>
